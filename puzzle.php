...
<body>
    ...
    <div class="container-scacchiera">
        <div class="scacchiera" id="scacchieraPuzzle"></div>
            <div class="container-bottoni">
                <button id="nuovoPuzzle"><i class='bx bx-chevrons-right' ></i>Nuovo</button>
                <button id="risolviPuzzle"><i class='bx bx-bulb'></i>Risolvi</button>
    ...
    <script src="https://unpkg.com/@chrisoakman/chessboardjs@1.0.0/dist/chessboard-1.0.0.min.js"
            ...
            crossorigin="anonymous"></script>
    <script src="js/problemi.js"></script>
</body>
</html>
